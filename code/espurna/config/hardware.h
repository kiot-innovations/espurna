...
#elif defined(Nexa_3)
    #define MANUFACTURER COMPANY_NAME
    #define DEVICE "SW_3_REL"
    #define NEXA 1
    #define RELAY1_NUM 1  //4
    #define RELAY2_NUM 2  //5
    #define RELAY3_NUM 3  //5
    #define RELAY1_PIN 4
    #define RELAY2_PIN 5
...
// ============================================================
...
#elif defined(Nexa_Dimmer)
    //Need to add all other necessary settings
    #define MANUFACTURER COMPANY_NAME
    #define DEVICE "SW_DIM"
    #define RELAY1_NUM 1
    #define DIMMER_NUM 1
    ...
    #define DIMMING_LEVELS 5
    #define DIMMER_PINS_COUNT 4
    const int DIMMER_PINS[DIMMER_PINS_COUNT] = {4, 5, 12, 13};
    #define BUTTON1_MODE BUTTON_PUSHBUTTON | BUTTON_DEFAULT_HIGH
    #define BUTTON1_PIN 14
    #define BUTTON1_RELAY 1
    #define LED_PROVIDER NEOPIXEL_LED
